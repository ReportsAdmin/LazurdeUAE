select cal.date,a.FB_M_ga_uniqueEvents,G_M_ga_uniqueEvents,L_M_ga_uniqueEvents ,'Lazurde_Egypt' Halo_Country from
(select Date from `noted-computing-279322.halo_1_1_lazurdeEgypt.Calendar` )cal
left join
