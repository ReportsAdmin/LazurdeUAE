select *,row_number() over (partition by user_id order by orders desc,revenue desc) Productcategory_rank,'Lazurde_Egypt' Halo_Country
from(
...
from
`noted-computing-279322.halo_1_1_lazurdeEgypt.fOrders` ord,
`noted-computing-279322.halo_1_1_lazurdeEgypt.refProducts` cat
