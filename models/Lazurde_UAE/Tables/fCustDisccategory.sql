select *,row_number() over (partition by user_id order by cnt_orders desc) disc_cat_rank,'Lazurde_Egypt' Halo_Country
from(
...
`noted-computing-279322.halo_1_1_lazurdeEgypt.refCustDisccategory` b
