...
(select count(distinct userid) registered_users,date(activateddate) activateddate  from `noted-computing-279322.halo_1_1_lazurdeUAE.refUsers`
...
(select sum(cast(M_ga_users as int64)) as new_visitors,startdate date_start from `noted-computing-279322.halo_1_1_lazurdeUAE.fGABaseVisitors`
