...
left join
(select distinct entity_id,value as val,'1' jointvalue from `noted-computing-279322.halo_1_1_lazurdeUAE.magento_productentityvarchar`
-- where attribute_id = 84
)b
on a.joinvalue=b.jointvalue
left join
( select distinct value_id url_id,entity_id product_id1,position from  `noted-computing-279322.halo_1_1_lazurdeUAE.magento_Image3`
where disabled = 0)c
