select safe_divide(PaymentPage,Transaction) payment_trnx ,D_ga_deviceCategory,StartDate,'Lazurde_Egypt' Halo_Country from(
...
from `noted-computing-279322.halo_1_1_lazurdeEgypt.fGABaseShoppingStages` )
group by 3,4)